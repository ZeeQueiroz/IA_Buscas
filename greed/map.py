"""
Módulo que define o mapa da Romênia no formato de grafo, considerando a heuristica.
"""

class Vertex:
    """
    Classe que define um vértice, como uma cidade tendo seus adjacentes (rotas), 
    e considerando a heuristica (distancia em linha reta do vértice até Bucareste)
    """
